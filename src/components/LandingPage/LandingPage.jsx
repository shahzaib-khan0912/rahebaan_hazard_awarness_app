...
import { 
  MapPin, ShieldAlert, Mic, BrainCircuit, Users, Navigation, 
  ArrowRight, Activity, Bell, Map as MapIcon, ChevronRight
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg selection:bg-primary selection:text-dark-bg">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 glass-panel border-x-0 border-t-0 rounded-none bg-dark-bg/60">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] border border-white/5 rounded-full animate-[spin_60s_linear_infinite] border-dashed" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-md">
              ...
              <span className="text-xs font-semibold tracking-wider uppercase text-gray-300">Live in Pakistan</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="mt-12 flex items-center gap-6 text-sm text-gray-500 font-medium">
              <div className="flex -space-x-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className={`w-10 h-10 rounded-full border-2 border-dark-bg bg-gray-800 flex items-center justify-center text-xs text-white z-[${10-i}]`}>
                    User
                  </div>
                ))}
              </div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-dark-card to-white/5 rounded-[2.5rem] border border-white/10 shadow-2xl backdrop-blur-xl overflow-hidden flex items-center justify-center">
              ...
              <motion.div className="relative w-full h-full p-8" animate={{ y: [0, -10, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}>
                ...
                <div className="absolute top-10 left-10 glass-panel p-4 flex items-center gap-4 w-64 transform -rotate-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Reported 2 mins ago</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-20 right-10 glass-panel p-4 flex items-center gap-4 w-64 transform rotate-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Verified by 5 users</p>
                  </div>
                </div>
      ...
      <section id="features" className="py-24 relative bg-black/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-gray-400">Our platform utilizes cutting-edge technology to ensure accurate, instant, and actionable road hazard reporting.</p>
          </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={idx} className="glass-panel p-6 relative overflow-hidden group">
                  <div className="absolute -right-4 -top-4 text-7xl font-bold text-white/5 group-hover:text-primary/10 transition-colors">
                    {item.step}
                  </div>
                  <div className="w-12 h-12 rounded-full bg-dark-bg border border-white/10 flex items-center justify-center font-bold text-primary mb-4 relative z-10">
                    {item.step}
                  </div>
      ...
      {/* Live Stats */}
      <section id="stats" className="py-20 bg-primary/5 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <section className="py-32 relative overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl text-gray-400 mb-10">Join thousands of citizens reporting hazards and helping authorities make our cities safer.</p>
      ...
      {/* Footer */}
      <footer className="border-t border-white/10 bg-dark-bg py-8 text-center text-gray-500 text-sm">
